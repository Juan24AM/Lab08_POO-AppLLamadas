...
public class Validator {
     ...
     * el nombre del valor incorrecto
     */
    public static String validarMinutos(String minutos, Integer minimo) {
        return minutos.matches(String.format("\\d+", minimo)) ? null : "Minutos no es valido";
    }
     ...
     */
    public static String verificarCampos(String dni, String nombre, String tipoPlan, String tipoLlamada, String minutos){
